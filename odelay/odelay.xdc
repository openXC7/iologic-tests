...
set_property LOC V13 [get_ports delay_out0]
set_property IOSTANDARD LVCMOS18 [get_ports {delay_out0}]

set_property LOC W13 [get_ports delay_out1]
set_property IOSTANDARD LVCMOS18 [get_ports {delay_out1}]

set_property LOC Y25 [get_ports clkout0]
set_property IOSTANDARD LVCMOS18 [get_ports {clkout0}]

set_property LOC Y26 [get_ports clkout1]
set_property IOSTANDARD LVCMOS18 [get_ports {clkout1}]

create_clock -name clk100 -period 5.0 [get_nets clk_in]
